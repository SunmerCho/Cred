...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title_text}>What is your monthly take home income?</Text>

      <Text style={styles.desc_text}>The amount you receive each month after tax, NI and any pension deductions. If you have been furloughed, then we need the amount of furlough pay you receive.</Text>

      <TextFiled style={styles.input} label="Amount (£)" type='numeric' onChange={(text) => setInput(text)} />

      <ButtonOrange style={styles.btn} title='Next' opacity={input == '' ? 0.5 : 1} onPress={() => { input == '' ? null : router.push('/organic/Mortgage') }} />
    </View>
  );
}

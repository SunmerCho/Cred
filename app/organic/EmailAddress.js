...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView >
        <View >
          <Header step={'1'} progress={4 / 26} display={'flex'} />
          ...
          <TextFiled style={styles.input} label="Email address" text={text} keyboardType='email-address' onChange={onChangeText} />

          <ButtonOrange style={{ marginTop: pxToDp(240) }} title='Next' opacity={0.5} onPress={() => navigation.push('/organic/Password')} />
